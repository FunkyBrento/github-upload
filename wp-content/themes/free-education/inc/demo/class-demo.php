...
if ( ! class_exists( 'Free_Education_Demo' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class Free_Education_Demo {

		/**
		 * Singleton instance of Free_Education_Demo.
		 *
		 * @var Free_Education_Demo $instance Free_Education_Demo instance.
		 */
		...
		/**
		 * Main Free_Education_Demo instance.
		 *
		 * @since 1.0.0
		 *
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Free_Education_Demo ) ) {
				self::$instance = new Free_Education_Demo();
